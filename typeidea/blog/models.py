...
class Post(models.Model):
    ...
    def get_by_tag(self, tag_id):
        try:
            ...
            post_list = tag.post_set.filter(status=STATUS_NORMAL).select_related('owner', 'category')
    ...
    def get_by_category(category_id):
        try:
            ...
            post_list = category.post_set.filter(status=STATUS_NORMAL).select_related('owner', 'category')
